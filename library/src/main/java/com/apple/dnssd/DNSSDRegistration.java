...
/**	A tracking object for a registration created by {@link com.apple.dnssd.DNSSD#register}. */
...
public interface	DNSSDRegistration extends DNSSDService
{
	/** Get a reference to the primary TXT record of a registered service.<P> 
		...
		<P>
		@return		A {@link com.apple.dnssd.DNSRecord}.
					If {@link com.apple.dnssd.DNSSDRegistration#stop} is called, the DNSRecord is also
	...
	*/
	...
	/** Add a record to a registered service.<P> 
		...
		<P>
		@return		A {@link com.apple.dnssd.DNSRecord} that may be passed to updateRecord() or removeRecord().
					If {@link com.apple.dnssd.DNSSDRegistration#stop} is called, the DNSRecord is also
					invalidated and may not be used further.
	*/
